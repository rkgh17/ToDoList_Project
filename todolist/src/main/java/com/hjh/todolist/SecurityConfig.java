...
//
//import com.hjh.todolist.jwt.CustomAuthenticationFilter;
//import com.hjh.todolist.jwt.JwtAuthorizationFilter;
//
//
//@Configuration
//@EnableWebSecurity
...
//	
//	/**
//	 * 1. 정적 자원 (Recource)에 대해서 인증된 사용자가 정적 자원의 접근에 대해 '인가'에 대한 설정을 담당하는 메서드.
//	 * 
...
//		// 정적 자원에 대해서 Security를 적용 x
//		return web -> web.ignoring().requestMatchers(PathRequest.toStaticResources().atCommonLocations());
//	}
//	
//	/**
//	 * 2. HTTP에 대해서 '인증' 과  '인가'를 담당하는 메서드이며 필터를 통해 인증 방식과 인증 절차에 대해
//	 * 	  등록하며 설정을 담다하는 메서드.
//	 * 
...
//			
//			// [STEP4] Session기반의 인증기반을 사용하지 않고 추후 JWT를 이용하여서 인증 예정
//			.sessionManagement().sessionCreationPolicy(SessionCreationPolicy.STATELESS)
//			
//			.and()
//			
//			// [STEP5] form 기반의 로그인에 대해 비 활성화하며 커스텀으로 구성한 필터를 사용
//			.formLogin().disable()
//			
